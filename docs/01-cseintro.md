...
- Performance Isolation（性能隔离、互不干扰）、Energy Efficiency高效
...
![Undefined behavior](./01-cseintro.assets/ub.png)
...
![O2-noO2](./01-cseintro.assets/O2-noO2.png)
...
![latency延迟](./01-cseintro.assets/latency.png)
...
![截屏2023-12-29 19.22.35](./01-cseintro.assets/c-t.png)
...
![utilization](./01-cseintro.assets/utilization.png)
...
![Fault Tolerance](./01-cseintro.assets/FaultTolerance.png)
...
![A-B](./01-cseintro.assets/A-B.png)
...
![截屏2023-12-29 21.22.42](./01-cseintro.assets/ppt1.png)

- 所以：A从开始发送数据，到10微秒之间的这个时间，如果A没有收到数据，那就说明B没有发送数据
- 为什么？考虑中间情况，这个时间t一定小于10微秒
- 补一句：课件上面的毫秒写错了

![截屏2023-12-29 21.24.51](./01-cseintro.assets/ppt2.png)
...
![截屏2023-12-29 21.48.52](./01-cseintro.assets/Hierarchy.png)

### 四、课程架构

考试要求：期中-30分；期末-30分；Lab-40分

![课程架构](./01-cseintro.assets/course.png)
